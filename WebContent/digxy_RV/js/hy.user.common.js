...
//			html.push(loginUrl);
		...
		loginDialog : function(loginUrl, num) {
			...
			var tab = "<p id='tab_header_login' class='tab_header'><span onclick='hyCom.selectedTab(\"login\",0)'"
					+ " class='selected'>登录</span><span  onclick='hyCom.selectedTab(\"login\",1)' >注册</span></p>";
			html.push(tab);
			...
			html.push('						<input type="text" id="pwd" name="pwd" placeholder="请输入密码"/>');
