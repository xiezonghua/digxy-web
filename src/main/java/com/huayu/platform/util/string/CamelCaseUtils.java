...
public class CamelCaseUtils {
    ...
    public static String toCamelCase(String s , int separatorIndex) {
        if (s == null) {
            return null;
        }
    ...
    public static String toUpperCaseStart(String camelCase){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(CamelCaseUtils.toCamelCase("iso_certified_staff",1));
